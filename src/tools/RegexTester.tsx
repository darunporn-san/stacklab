        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-end gap-3">
            <div className="flex-1 min-w-[200px] space-y-1">
              <label className="text-sm font-medium text-muted-foreground">{t("regex.pattern")}</label>
              <input
                value={pattern}
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-muted-foreground">{t("regex.testString")}</label>
            <textarea
              value={testText}
          ...
          {testText && pattern && !error && (
            <>
              <div className="flex items-center gap-3 text-sm text-muted-foreground">
                <span><span className="font-medium text-foreground">{Array.isArray(matches) ? matches.length : 0}</span> {t("regex.matchesFound")}</span>
