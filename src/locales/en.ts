const en = {
  ...
  tools: {
    ...
    uriEncoderDecoder: "URI Encoder / Decoder",
  ...
  uri: {
    ...
    subtitle: "Encode or decode URI strings and query parameters using JavaScript's built-in functions.",
    seoDesc: "Encode and decode URI strings and components online. Supports encodeURI, encodeURIComponent, decodeURI, decodeURIComponent. Free, fast, and runs entirely in your browser.",
    whatIs: "URI encoding is used to encode special characters in URLs and query parameters. JavaScript provides encodeURI() for full URLs and encodeURIComponent() for individual components like query parameters.",
    howTo1: "1. Enter text or URL to encode/decode.",
    howTo2: "2. Choose the appropriate encoding/decoding function.",
    howTo3: "3. Copy the result with the copy button.",
    faqDifference: "What's the difference between encodeURI and encodeURIComponent?",
    faqDifferenceA: "encodeURI() encodes characters that have special meaning in URLs but leaves characters like :, /, ;, and ? untouched. encodeURIComponent() encodes all characters except A-Z a-z 0-9 - _ . ! ~ * ' ( )",
    faqWhen: "When should I use each function?",
    faqWhenA: "Use encodeURI() for encoding entire URLs. Use encodeURIComponent() for encoding individual components like query parameter values.",
    faqSize: "Is there a size limit?",
    faqSizeA: "No hard limit — it runs in your browser, so it depends on available memory.",
  },
  // JWT
